...
-- ========== Policy ==========
INSERT INTO user_management.Policy (id, type, criteria, identifier, condition, criteria_script, action_name,
                                    action_script, action_params, created_by, created_at, version)
...
INSERT INTO user_management.Policy (id, type, criteria, identifier, condition, criteria_script, action_name,
                                    action_script, action_params, created_by, created_at, version)
VALUES (6000, 'BLACKLIST', 'COUNTRY', 'XX', '#criteria == ''XX''', 'return request.getHeader(''X-Country'')',
