...
call mvn -f logger-log4j2-database/pom.xml clean package -DskipTests=true
...
call mvn -f security-authentication-inmemory/pom.xml clean package
call mvn -f security-rbac/pom.xml clean package
